...
if(OBJECT_ID('tempdb..#temp_rolemember')>1)
DROP TABLE #temp_rolemember 
if(OBJECT_ID('tempdb..#temp_rolemember_final')>1)
DROP TABLE #temp_rolemember_final
if(OBJECT_ID('tempdb..#temp_groupadmin')>1)
DROP TABLE #temp_groupadmin
if(OBJECT_ID('tempdb..#temp_groupadmin2')>1)
DROP TABLE #temp_groupadmin2 
if(OBJECT_ID('tempdb..#temp_srvrole')>1)
DROP TABLE #temp_srvrole 
if(OBJECT_ID('tempdb..#temp_memberrole')>1)
...
/*
--server level permission like endpoint
Select db_name() , * from sys.server_permissions 
Select * from sys.server_principals where name   like '%delpo%'
*/